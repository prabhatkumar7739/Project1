export const releaseNotesTableData = [
  {
    ...
    minorImprovements: [
      ...
      },
      {
        ...
        values: [
          "Users can request a role change directly within the platform. Admins have the ability to approve or deny these requests.Access to specific features and operations will adjust automatically.",
    ...
    majorFeatures: [
      {
        ...
        values: [
          "Customers are enabled with DataDog telemetry connector to fetch metrics, supporting advisory services. This effort serves as a backup for the need to use the StatsCollector tool offered previously.",
